...
- Do not use this skill as a replacement for product discovery, visual design, or framework-specific API documentation.
- Keep the work focused on accessibility behavior, interaction contracts, evidence, and conformance boundaries; route unrelated concerns to the relevant project guidance.
- Consult the current official documentation for the chosen framework or component library after defining the semantic and interaction contract.
